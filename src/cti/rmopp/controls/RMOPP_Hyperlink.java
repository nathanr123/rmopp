...
public class RMOPP_Hyperlink extends JButton {
	 ...
	 * Creates a new instance of JHyperlink
	 */
	public RMOPP_Hyperlink(String text) {
	...
	public RMOPP_Hyperlink(String text, String targetURI)
			throws URISyntaxException {
		
		this(text, new URI(targetURI));
	}

	public RMOPP_Hyperlink(String text, URI target) {
	...
	public RMOPP_Hyperlink(String text, Action action) {
	...
	public RMOPP_Hyperlink(String text, Icon icon) {
	...
	public RMOPP_Hyperlink(Icon icon, String targetURI)
			throws URISyntaxException {
		
		this(null, icon, targetURI);
	}

	public RMOPP_Hyperlink(String text, Icon icon, String targetURI)
			throws URISyntaxException {
	...
	public RMOPP_Hyperlink(String text, Icon icon, URI target) {
	...
	private static class BrowseAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			RMOPP_Hyperlink hyperlink = (RMOPP_Hyperlink) e.getSource();
